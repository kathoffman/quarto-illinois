---
title: Overview of the University of Washington Revealjs Theme
subtitle: "Your Course - Semester YYYY @ University of Washington"
author: First Last
date: last-modified
format:
...
```bash
quarto install extension coatless/quarto-uw
```

Install the theme with the template being present:

```bash
quarto use template coatless/quarto-uw
```
